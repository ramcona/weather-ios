...
class SheetCityViewController: BaseViewController {
    
    @IBOutlet weak var textFieldSearch: UITextField!
    @IBOutlet weak var tableViewData: UITableView!
    
    //variables
    public var completionHandler: ((_ data:City) -> Void)?
    public var provinceId:String = ""
    private var viewModel = CityViewModel()
    private var cellName = "dataCell"
    private var listData:[City] = [City]()
    private var listDataFiltered:[City] = [City]()
    ...
    private func setupData() {
        ...
        viewModel.fetch(provinceId: provinceId)
    }
    
    private func action() {
        
        tableViewData.addRefreshControl {
            self.viewModel.fetch(provinceId: self.provinceId)
...
extension SheetCityViewController: UITableViewDelegate, UITableViewDataSource {
